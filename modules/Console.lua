...
local function main()
    ...
    ConsoleFrame["BorderColor3"] = Theme.Black;
    ...
    G2L["3"]["BackgroundColor3"] = Theme.ConsoleDarkBG;
    ...
    G2L["3"]["BorderColor3"] = Theme.Black;
    ...
    G2L["5"]["BackgroundColor3"] = Theme.White;
    ...
    G2L["5"]["ScrollBarImageColor3"] = Theme.ConsoleButtonActive;
    G2L["5"]["BorderColor3"] = Theme.Black;
    ...
    G2L["6"]["PlaceholderColor3"] = Theme.PlaceholderGray;
    G2L["6"]["BorderSizePixel"] = 0;
    G2L["6"]["TextSize"] = 13;
    G2L["6"]["TextColor3"] = Theme.PlaceholderGray;
    G2L["6"]["BackgroundColor3"] = Theme.White;
    G2L["6"]["FontFace"] = Font.new([[rbxasset://fonts/families/Inconsolata.json]], Enum.FontWeight.Regular,
    ...
    G2L["6"]["BorderColor3"] = Theme.Black;
    G2L["6"]["Text"] = [[]];
    ...
    G2L["8"]["BackgroundColor3"] = Theme.White;
    G2L["8"]["FontFace"] = Font.new([[rbxasset://fonts/families/Inconsolata.json]], Enum.FontWeight.Regular,
        Enum.FontStyle.Normal);
    G2L["8"]["TextColor3"] = Theme.White;
    G2L["8"]["BackgroundTransparency"] = 1;
    G2L["8"]["RichText"] = true;
    G2L["8"]["Size"] = UDim2.new(0, 246, 0, 22);
    G2L["8"]["BorderColor3"] = Theme.Black;
    G2L["8"]["Text"] = [[]];
    ...
    G2L["backgroundOutput"]["BackgroundColor3"] = Theme.ConsoleOutputBG;
    ...
    G2L["backgroundOutput"]["BorderColor3"] = Theme.Black;
    ...
    G2L["a"]["TopImage"] = '';
    G2L["a"]["BackgroundColor3"] = Theme.ConsoleOutputBG;
    ...
    G2L["a"]["BorderColor3"] = Theme.Black;
    G2L["a"].ScrollBarImageColor3 = Theme.ConsoleScrollBar
    ...
    G2L["c"]["Color"] = Theme.VeryDarkGray2;
    ...
    G2L["10"]["BackgroundColor3"] = Theme.ConsoleDarkBG;
    G2L["10"]["ClipsDescendants"] = true;
    G2L["10"]["Size"] = UDim2.new(0, 37, 0, 15);
    G2L["10"]["Position"] = UDim2.new(0, 4, 0, 4);
    G2L["10"]["BorderColor3"] = Theme.Black;
    G2L["10"]["Name"] = [[TextSizeBox]];

    -- StarterGui.ScreenGui.Console.TextSizeBox.TextBox
    G2L["11"] = Instance.new("TextBox", G2L["10"]);
    G2L["11"]["PlaceholderColor3"] = Theme.ConsoleTextGray;
    G2L["11"]["BorderSizePixel"] = 0;
    G2L["11"]["TextWrapped"] = true;
    G2L["11"]["TextSize"] = 15;
    G2L["11"]["TextColor3"] = Theme.PlaceholderGray;
    G2L["11"]["TextScaled"] = true;
    G2L["11"]["BackgroundColor3"] = Theme.White;
    G2L["11"]["FontFace"] = Font.new([[rbxasset://fonts/families/Inconsolata.json]], Enum.FontWeight.Regular,
        Enum.FontStyle.Normal);
    G2L["11"]["PlaceholderText"] = [[Size]];
    G2L["11"]["Size"] = UDim2.new(1, 0, 1, 0);
    G2L["11"]["BorderColor3"] = Theme.Black;
    G2L["11"]["Text"] = [[]];
    ...
    G2L["14"]["BackgroundColor3"] = Theme.ConsoleButtonActive;
    G2L["14"]["Size"] = UDim2.new(0, 37, 0, 15);
    G2L["14"]["BorderColor3"] = Theme.Black;
    G2L["14"]["Name"] = [[Clear]];
    ...
    G2L["15"]["BackgroundColor3"] = Theme.White;
    G2L["15"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular,
        Enum.FontStyle.Normal);
    G2L["15"]["TextColor3"] = Theme.White;
    G2L["15"]["BackgroundTransparency"] = 1;
    G2L["15"]["Size"] = UDim2.new(1, 0, 1, 0);
    G2L["15"]["BorderColor3"] = Theme.Black;
    G2L["15"]["Text"] = [[Clear]];
    ...
    G2L["17"]["TextSize"] = 15;
    G2L["17"]["TextColor3"] = Theme.ConsoleTextLight;
    G2L["17"]["BackgroundColor3"] = Theme.White;
    ...
    G2L["17"]["BorderColor3"] = Theme.Black;
    ...
    G2L["19"]["BackgroundColor3"] = Theme.ConsoleButtonActive;
    G2L["19"]["Size"] = UDim2.new(0, 60, 0, 15);
    G2L["19"]["BorderColor3"] = Theme.Black;
    ...
    G2L["1a"]["BackgroundColor3"] = Theme.White;
    G2L["1a"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular,
        Enum.FontStyle.Normal);
    G2L["1a"]["TextColor3"] = Theme.White;
    G2L["1a"]["BackgroundTransparency"] = 1;
    G2L["1a"]["Size"] = UDim2.new(1, 0, 1, 0);
    G2L["1a"]["BorderColor3"] = Theme.Black;
    ...
    G2L["20"]["BackgroundColor3"] = Theme.ConsoleButtonActive;
    G2L["20"]["Size"] = UDim2.new(0, 60, 0, 15);
    G2L["20"]["BorderColor3"] = Theme.Black;
    ...
    G2L["1e"]["BackgroundColor3"] = Theme.White;
    G2L["1e"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular,
        Enum.FontStyle.Normal);
    G2L["1e"]["TextColor3"] = Theme.White;
    G2L["1e"]["BackgroundTransparency"] = 1;
    G2L["1e"]["Size"] = UDim2.new(1, 0, 1, 0);
    G2L["1e"]["BorderColor3"] = Theme.Black;
    ...
    G2L_MODULES[G2L["1d"]] = {
        Closure = function()
            ...
            local highlighter = {}
            local keywords = {
                lua = {"and", "break", "or", "else", "elseif", "if", "then", "until", "repeat", "while", "do", "for",
                       "in", "end", "local", "return", "function", "export"},
                rbx = {"game", "workspace", "script", "math", "string", "table", "task", "wait", "select", "next",
                       "Enum", "error", "warn", "tick", "assert", "shared", "loadstring", "tonumber", "tostring",
                       "type", "typeof", "unpack", "print", "Instance", "CFrame", "Vector3", "Vector2", "Color3",
                       "UDim", "UDim2", "Ray", "BrickColor", "OverlapParams", "RaycastParams", "Axes", "Random",
                       "Region3", "Rect", "TweenInfo", "collectgarbage", "not", "utf8", "pcall", "xpcall", "_G",
                       "setmetatable", "getmetatable", "os", "pairs", "ipairs"},
                exploit = {"hookmetamethod", "hookfunction", "getgc", "filtergc", "Drawing", "getgenv", "getsenv",
                           "getrenv", "getfenv", "setfenv", "decompile", "saveinstance", "getrawmetatable",
                           "setrawmetatable", "checkcaller", "cloneref", "clonefunction", "iscclosure", "islclosure",
                           "isexecutorclosure", "newcclosure", "getfunctionhash", "crypt", "writefile", "appendfile",
                           "loadfile", "readfile", "listfiles", "makefolder", "isfolder", "isfile", "delfile",
                           "delfolder", "getcustomasset", "fireclickdetector", "firetouchinterest",
                           "fireproximityprompt"},
                operators = {"#", "+", "-", "*", "%", "/", "^", "=", "~", "=", "<", ">", ", ", ".", "(", ")", "{", "}",
                             "[", "]", ";", ":"}
            }
            ...
            local colors = {
                numbers = Theme.Syntax.Number,
                boolean = Theme.Syntax.Number,
                operator = Theme.Syntax.Operator,
                lua = Theme.Syntax.BuiltIn,
                exploit = Theme.ConsoleSyntax.Exploit,
                rbx = Theme.Syntax.Keyword,
                str = Theme.ConsoleSyntax.String,
                comment = Theme.Syntax.Comment,
                null = Theme.Syntax.Number,
                call = Theme.ConsoleSyntax.LocalMethod,
                self_call = Theme.ConsoleSyntax.SelfMethod,
                local_color = Theme.ConsoleSyntax.LocalColor,
                function_color = Theme.ConsoleSyntax.FunctionColor,
                self_color = Theme.ConsoleSyntax.SelfColor,
                local_property = Theme.ConsoleSyntax.LocalProperty
            }
            ...
            function highlighter.run(source)
                ...
                for i, token in ipairs(tokens) do
                    ...
                    if highlight then
                        local syntax = string.format("<font color = \"#%s\">%s</font>", highlight:ToHex(),
                            token:gsub("<", "&lt;"):gsub(">", "&gt;"))
    ...
    Console.Init = function()
        ...
        if CtrlScroll == true then
            Console.CtrlScroll.BackgroundColor3 = Theme.ListSelection
        elseif CtrlScroll == false then
            Console.CtrlScroll.BackgroundColor3 = Theme.ConsoleButton
        end
        ...
        if AutoScroll == true then
            Console.AutoScroll.BackgroundColor3 = Theme.ListSelection
