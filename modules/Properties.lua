...
local function main()
    ...
    Properties.DefaultPropValue = {
        ...
        Color3 = Theme.TextColor,
        Vector2 = Vector2.new(0, 0),
        Vector3 = Vector3.new(0, 0, 0),
        NumberSequence = NumberSequence.new(1),
        ColorSequence = ColorSequence.new(Theme.TextColor),
    ...
    Properties.NewPropEntry = function(index)
        ...
        nameFrame.Expand.InputBegan:Connect(function(input)
            ...
            local fullName = (prop.CategoryName and "CAT_" .. prop.CategoryName) or prop.Class .. "." .. prop.Name ..
                                 (prop.SubName or "")
    ...
    Properties.IsTextEditable = function(prop)
        ...
        return typeName ~= "bool" and typeData.Category ~= "Enum" and typeData.Category ~= "Class" and typeName ~=
                   "BrickColor"
    end
    ...
    Properties.DisplayProp = function(prop, entryIndex)
        ...
        if (typeName == "Color3" or typeName == "BrickColor" or typeName == "ColorSequence") then
            ...
            if propVal then
                ...
                gradient.Color = ColorSequence.new(Theme.TextColor)
            end
            colorPreview.BorderColor3 = (typeName == "ColorSequence" and Theme.TextColor or Theme.Outline3)
            offset = 22
        ...
        for i = 1, maxEntries do
            ...
            if prop then
                ...
                if prop.SpecialRow then
                    ...
                    local gName =
                        (prop.CategoryName and "CAT_" .. prop.CategoryName) or prop.Class .. "." .. prop.Name ..
                            (prop.SubName or "")
                    ...
                    if prop.CategoryName then
                        ...
                        expand.Visible = typeData.Category == "DataType" and Properties.ExpandableTypes[typeName] or
                ...
                pcall(function()
                    ...
                    if rootTypeName then
                        ...
                        elseif rootTypeName == "CFrame" then
                            local rootPos, rootRight, rootUp, rootLook = root.Position, root.RightVector, root.UpVector,
                                root.LookVector
                        ...
                        elseif rootTypeName == "PhysicalProperties" then
                            ...
                            local friction = (subName == ".Friction" and setVal) or (root and root.Friction) or
                                                 rootProps.Friction
                            local elasticity = (subName == ".Elasticity" and setVal) or (root and root.Elasticity) or
                        ...
                        elseif rootTypeName == "Ray" then
                            ...
                            local direction = (subName == ".Direction" and setVal) or
                                    ...
                                    (subName == ".Direction.Y" and setVal) or rootDirection.Y, (subName ==
                                        ".Direction.Z" and setVal) or rootDirection.Z)
    ...
    Properties.InitEntryStuff = function()
        Properties.EntryTemplate = create({{1, "TextButton", {
            ...
            TextTransparency = 0.10000000149012,
            Visible = false
        }} -- {27, "UIStroke", {ApplyStrokeMode=Enum.ApplyStrokeMode.Border, Color=Theme.Outline2, Thickness=1, Parent={1}}}
        })
    ...
    Properties.Init = function() -- TODO: MAKE BETTER
        local guiItems = create({{1, "Folder", {
            ...
            Name = "SearchBox",
            Parent = {3},
            PlaceholderColor3 = Theme.PlaceholderGray,
            ...
            ImageColor3 = Theme.PlaceholderGray,
            Parent = {6},
            Size = UDim2.new(0, 16, 0, 16)
        }}, {8, "TextButton", {
            AutoButtonColor = false,
